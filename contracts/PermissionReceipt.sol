// SPDX-License-Identifier: MIT
 codex/create-hardhat-files-for-permissionreceipt-contract
...
contract PermissionReceipt is ERC721URIStorage {
    ...
    event ReceiptRevoked(uint256 indexed tokenId, address indexed granter, address indexed grantee, uint256 revokedAt);

    constructor() ERC721("PermissionReceipt", "PRCPT") {}

    function mint(address to, string calldata scope, string calldata metadataURI) external returns (uint256 tokenId) {
